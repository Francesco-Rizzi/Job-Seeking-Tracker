		...
		return (
			<div className={ns}>
				...
				<div className={`${ns}-img-wrap`}>
					...
					<h2 className={`${ns}-desc`}>I'm Francesco, if you want to discover some more stuff about me, check out these links: <a rel="me nofollow" href="https://frarizzi.science" target="_blank" title="Personal website">my website</a>, <a rel="me nofollow" target="_blank" href="https://github.com/Francesco-Rizzi" title="GitHub profile">GitHub</a>, <a rel="me nofollow" target="_blank" href="https://www.linkedin.com/in/francesco-rizzi-199524a5/" title="LinkedIn profile">LinkedIn</a>, <a rel="me nofollow" target="_blank" href="https://twitter.com/0xFFrancesco" title="Twitter profile">Twitter @0xFFrancesco</a>, <a target="_blank" href="https://www.instagram.com/0xffrancesco/" title="Instagram profile" rel="me nofollow">Instagram @0xFFrancesco</a>, <a href='https://medium.com/@francesco_rizzi' target='_blank' rel="me nofollow" title='Medium profile'>Medium</a>.
					</h2>
				</div>
